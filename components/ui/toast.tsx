...
const Toast: React.FC<ToastProps> = ({
  ...
  const typeConfig = {
    success: {
      icon: <CheckCircle size={22} color={isDark ? "#10B981" : "#059669"} />,
    ...
    error: {
      icon: <AlertCircle size={22} color={isDark ? "#F87171" : "#DC2626"} />,
    ...
    info: {
      icon: <Info size={22} color={isDark ? "#60A5FA" : "#2563EB"} />,
    ...
    warning: {
      icon: <AlertTriangle size={22} color={isDark ? "#FBBF24" : "#D97706"} />,
