  ...
  return (
    <View className="mt-4">
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <TouchableOpacity className="mr-4 w-64 bg-card dark:bg-card-dark rounded-xl shadow-md overflow-hidden">
            {item.sponsored && (
              ...
              <View className="flex-row justify-between mt-3">
                <View className="flex-row items-center">
                  <MaterialIcons
                    ...
                    color="#666"
                  />
                  <Text className="text-sm text-foreground-muted dark:text-foreground-muted-dark ml-1">
                    {item.deliveryFee}
                  </Text>
                </View>
